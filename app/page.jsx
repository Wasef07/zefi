    ...
    <div className="mt-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuresData.map((feature, index) => (
              <Card key={index} className="p-6">
                ...
                {feature.icon}
                <h3 className="text-xl fot-semibold">{feature.title}</h3>
            ...
            {testimonialsData.map((testimonials, index) => (
              <Card key={index} className="p-6">
                ...
                <div className="flex items-center mb-4">
                  <Image src={testimonials.image} alt={testimonials.name} width={40} height={40} className="rounded-full" />
                  <div className="ml-4">
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className=" text-white text-3xl font-bold text-center mb-4">Ready to Take Control of Your Finances?</h2>
